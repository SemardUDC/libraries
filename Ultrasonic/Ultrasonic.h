...
class Ultrasonic
{
  ...
  public:
    Ultrasonic(uint8_t trigger_pin, uint8_t echo_pin, unsigned int max_distance);
    Ultrasonic(uint8_t trigger_pin, uint8_t echo_pin, unsigned int max_distance, void (*callback)(unsigned int));
    ~Ultrasonic();
