// ---------------------------------------------------------------------------
// NewPingPCF8574 Library - v1.9.1 - 07/15/2018
//
// AUTHOR/LICENSE:
...
// available ping and ultrasonic libraries causing the problem. The NewPingPCF8574
...
//
// CONSTRUCTOR:
//   NewPingPCF8574 sonar(trigger_pin, echo_pin [, max_cm_distance])
...
//   NewPingPCF8574::convert_in(echoTime) - Convert echoTime from microseconds to inches (rounds to nearest inch).
//   NewPingPCF8574::convert_cm(echoTime) - Convert echoTime from microseconds to centimeters (rounds to nearest cm).
...
//   NewPingPCF8574::timer_us(frequency, function) - Call function every frequency microseconds.
//   NewPingPCF8574::timer_ms(frequency, function) - Call function every frequency milliseconds.
//   NewPingPCF8574::timer_stop() - Stop the timer.
//
// HISTORY:
...
//   an object. For example: cm = NewPingPCF8574::convert_cm(distance);
//
...
//   you're also using NewPingPCF8574's ping_timer because both use Timer2 interrupts).
...
//   doesn't give correct results (at least with ping sensors). The NewPingPCF8574
